...
Cloud Composer is a hosted version of the open source workflow tool - Airflow 
...
You can set environment variables within an Airflow instance through the admin page of the airflow webserver
